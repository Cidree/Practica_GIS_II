...
mdt <- raster(here("Cartografia/CartografiaOriginal/PNOA_MDT05_ETRS89_HU30_1051_LID.asc"),
...
```{r}
segmentation1500 <- read_sf(here("Cartografia/CapasDefVectorial/segmentacion_1500.shp"))

segmentation2000 <- read_sf(here("Cartografia/CapasDefVectorial/segmentacion_2000.shp"))

segmentation2500 <- read_sf(here("Cartografia/CapasDefVectorial/segmentacion_2500.shp"))
```
